-- supabase/migrations/20250826200500_create_pending_user_function_corrected.sql
...
BEGIN
    ...
    INSERT INTO public.user_registrations (email, password_hash, full_name, phone_number, status)
    VALUES (p_email, v_password_hash, p_full_name, p_phone, 'pending');
